    ...
    public class KeywordResponder
    {
        ...
        public KeywordResponder()
        {
            _responses = new Dictionary<string, List<string>>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "VPn", new List<string>{
                  "Using a VPN encrypts your internet traficc and protects your privacy online.",
                  "Always choose reputable VPN providers for better security."} },
                { "Security awareness", new List<string>{
                  "Regular training helps employees recongise threats like phishing.",
